...
<body>
	...
	<div class="top-header">
		<div class="container">
			...
			<ul class="tp-hd-rgt wow fadeInRight animated" data-wow-delay=".5s">
				<li class="sig"><a href="#" data-toggle="modal" data-target="#myModal">Hesabım</a></li>
				<li class="sigi"><a href="#" data-toggle="modal" data-target="#myModal4">/ Çıkış Yap</a></li>
			</ul>
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<nav class="cl-effect-1">
							<ul class="nav navbar-nav">
								...
								<li><a href="travels.html">Bilet Al</a></li>
								<li><a href="travels.html">Bilet Kontrol</a></li>
								<li><a href="privacy.html">İletişim</a></li>
								<li><a href="agent.html">Hakkımızda</a></li>
								<div class="clearfix"></div>
							</ul>
						</nav>
					</div>
	...
	<div class="container">
		<div class="col-md-5 bann-info1 wow fadeInLeft animated" data-wow-delay=".5s">
			...
			<h3>Üniversite Destekli Ulaşım Altyapısı</h3>
		</div>
		<div class="col-md-7 bann-info wow fadeInRight animated" data-wow-delay=".5s">
			...
			<div class="ban-top">
				<div class="bnr-left">Nereden
					...
					<select name="select" id="select" value="Terminal Giriniz">
			...
			<div class="ban-bottom">
				...
				<script>
					$(document).ready(function() {
						// Sayfa yüklendiğinde "Tek Yön" butonunun tıklanmış şekilde görünmesi için
						$('#seferler_buton_0').prop('checked', true);
						// Dönüş tarihi seçimi gizlenir
						$('#date').hide();
						// Dönüş tarihi: yazan kısmı gizler
						$('#date').prev('p').hide();

						// "Tek Yön" butonuna tıklandığında
						$('#seferler_buton_0').click(function() {
							// Dönüş tarihi seçimi gizlenir
							$('#date').hide();
							// Dönüş tarihi: yazan kısmı gizler
							$('#date').prev('p').hide();
						...
						// "Gidiş Dönüş" butonuna tıklandığında
						$('#seferler_buton_1').click(function() {
							// Dönüş tarihi seçimi görünür hale gelir
							$('#date').show();
							// Dönüş tarihi: yazan kısmı gösterilir
							$('#date').prev('p').show();
						});
					});
				</script>
			...
			<p class="butonlar">
				<label>
					<input type="radio" name="seferler_buton" value="Tekyon" id="seferler_buton_0">
					Tek Yön</label>
				<br>
				<label>
					<input type="radio" name="seferler_buton" value="Gidisdonus" id="seferler_buton_1">
					Gidiş Dönüş</label>
				<br>
			</p>

			<div class="sear">
				<form action="bus.php" class="otobusbtn">
					<button class="seabtn" href="bus.php">Otobüs Ara</button>
	...
	<div class="copy-right">
		<div class="container">
			...
			<p class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">© 2023 Umuttepe Turizm . All Rights Reserved | Design by <a href="http://w3layouts.com/" target="_blank">W3layouts</a> </p>
		</div>
	</div>
